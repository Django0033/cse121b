...
function renderTasks(tasks) {
    ...
    let tasksHTML = tasks.map(function (task) {
...
function newTask() {
    ...
    let newTaskDict = { detail: todoInput, completed: false };
    tasks.push(newTaskDict);
    renderTasks(tasks);
}
...
let buttonSubmitTask = document.getElementById("submitTask");
